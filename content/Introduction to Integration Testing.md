We're going to use [Playwright](https://playwright.dev) for our integration tests. A lot of the ideas translate over to some of the other browser-testing frameworks.
